                ...
                <x-auth-validation-errors class="mb-4" :errors="$errors" />
                        ...
                        <div class="-m-2">
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              ...
                              +files: Symfony\Component\HttpFoundation\FileBag {#1373 ▼
                                    #parameters: array:1 [▼
                                      "files" => array:2 [▼
                                        0 => array:1 [▼
                                          "image" => Symfony\Component\HttpFoundation\File\UploadedFile {#36 ▶}
                                        ]
                                        1 => array:1 [▼
                                          "image" => Symfony\Component\HttpFoundation\File\UploadedFile {#37 ▶}
                                        ]
                                      ]
                                    ]
                                  }
                          ...
                          <div class="p-2 w-full flex justify-around mt-4">
                            ...
                            <button type="submit" class="text-black bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">更新する</button>
                          </div>
                        </div>
                  </form>
                  <form id="delete_{{$image->id}}" method="post" action="{{ route('owner.images.destroy', ['image' => $image->id])}}">
                    ...
                    <div class="p-2 w-full flex justify-around mt-32">
                      <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" class="text-black bg-red-500 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除する</a>
                    </div>
                  </form>
              </div>
          </div>
