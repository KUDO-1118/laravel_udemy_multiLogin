                        ...
                        <div class="-m-2">
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              ...
                              <div class="w-full bg-gray-100 bg-opacity-50 rounded focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $owner->email }}</div>
                            </div>
                          </div>
                          <div class="p-2 w-1/2 mx-auto">
                          <div class="relative">
