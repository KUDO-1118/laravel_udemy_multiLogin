      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 bg-white border-b border-gray-200">
                      ...
                      <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            ...
                            @else
                                <img src="{{ asset('storage/no-image.png') }}">  <!-- 画像がない場合のデフォルト -->
                            @endif
                        </div>
                  ...
                  <div class="md-4 text-center">
                    <button data-micromodal-trigger="modal-1" href="javascript:;" type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-400 rounded">ショップの詳細を確認する</button>
                  </div>
              </div>
          </div>
      </div>
